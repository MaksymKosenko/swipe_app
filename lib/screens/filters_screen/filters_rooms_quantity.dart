...
class FiltersRoomQuantity extends StatefulWidget {
  final Filter _filter;
  FiltersRoomQuantity(this._filter);
  @override
  _FiltersRoomQuantityState createState() => _FiltersRoomQuantityState();
}

class _FiltersRoomQuantityState extends State<FiltersRoomQuantity> {
  ...
  setNewChoise(String newSelected) {
    setState(() {
      ...
      widget._filter.roomsQuantity = selectedVar;
      switch (newSelected) {
        case "1 комнатная":
          active1 = true;
          active2 = false;
  ...
  Widget build(BuildContext context) {
    if(widget._filter.roomsQuantity == null)
      widget._filter.roomsQuantity = selectedVar;
    else setNewChoise(widget._filter.roomsQuantity);
