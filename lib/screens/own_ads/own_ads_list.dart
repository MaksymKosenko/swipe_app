...
class OwnAdsScreen extends StatefulWidget {
  final String _phone;

  OwnAdsScreen(this._phone);

  @override
  _OwnAdsScreenState createState() => _OwnAdsScreenState();
}

class _OwnAdsScreenState extends State<OwnAdsScreen> {
  int quantity = 0;
  List _id = [];
  @override
  Widget build(BuildContext context) {
    CollectionReference _userSaves = FirebaseFirestore.instance.collection('users').doc(widget._phone).collection("user_collections").doc("myAd")
        .collection("myAds");
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                      ...
                      onTap: () => Navigator.push(context,
                          MaterialPageRoute(builder: (context) => OwnerFullAdCard(ApiAdd.fromApi(list2[index]), _id[index], _id))),
                      child: Container(
