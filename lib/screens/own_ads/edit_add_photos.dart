...
class EditAdPhotos extends StatefulWidget {
  final ConcreteUser _user;
  final Add _add;
  final ApiAdd _apiAdd;
  final String _addId;
  EditAdPhotos(this._user, this._add, this._apiAdd, this._addId);

  @override
  _EditAdPhotosState createState() => _EditAdPhotosState();
}


class _EditAdPhotosState extends State<EditAdPhotos> {
